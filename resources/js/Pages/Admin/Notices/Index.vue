    ...
    <vs-card>
      ...
      <vs-row vs-type="flex" vs-justify="space-between">
        ...
        <vs-col vs-type="flex" vs-justify="flex-end" vs-lg="6" vs-sm="6" vs-xs="12" class="mb-2">
          <inertia-link :href="route('admin.notices.create')">
            <vs-button color="primary" type="filled">New Notice</vs-button>
          </inertia-link>
        </vs-col>
      </vs-row>
      ...
      <vs-collapse id="div-with-loading" accordion type="margin" class="p-0 mt-5 mb-2">
        <vs-row class="header-collapse">
          ...
          <vs-col vs-w="4" vs-type="flex" vs-align="center">Heading</vs-col>
          <vs-col vs-w="4" vs-type="flex" vs-align="center">Roles</vs-col>
          ...
          >
            ...
            <vs-row vs-type="flex" vs-justify="flex-end">
              <vx-tooltip color="primary" title="Show" text="Show notice details.">
                <inertia-link :href="route('admin.notices.show',notice.id)">
                  <vs-button
                    radius
                    color="primary"
                    type="border"
              ...
              <vx-tooltip color="primary" title="Edit" text="Edit leave application info.">
                <inertia-link :href="route('admin.notices.edit',notice.id)">
                  <vs-button
                    radius
                    color="primary"
                    type="border"
...
export default {
  ...
  methods: {
    ...
    acceptDelete() {
      this.$vs.loading();
      this.$inertia
        .delete(this.route("admin.notices.destroy", this.notice.id), {
          preserveScroll: true,
          preserveState: true
        })
