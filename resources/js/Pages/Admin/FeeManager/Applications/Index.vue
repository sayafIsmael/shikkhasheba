    ...
    <vs-card>
      ...
      <vs-row vs-type="flex" vs-justify="space-between">
        ...
        <vs-col vs-type="flex" vs-justify="flex-end" vs-lg="6" vs-sm="6" vs-xs="12" class="mb-2">
          <inertia-link :href="route('admin.leave-applications.create')">
      ...
      <vs-collapse id="div-with-loading" accordion type="margin" class="p-0 mt-5 mb-2">
        <vs-row class="header-collapse">
          ...
          <vs-col vs-w="2" vs-type="flex" vs-align="center">Name</vs-col>
          <vs-col vs-w="3" vs-type="flex" vs-align="center">Title</vs-col>
          <vs-col vs-w="2" vs-type="flex" vs-align="center">Type</vs-col>
          ...
          >
            ...
            <vs-row vs-type="flex" vs-justify="flex-end">
              <vx-tooltip color="primary" title="Edit" text="Edit leave application info.">
                <inertia-link :href="route('admin.leave-applications.edit',leaveApplication.id)">
                  <vs-button
                    radius
                    color="primary"
                    type="border"
