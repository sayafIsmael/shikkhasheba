  ...
  <layout title="Teachers">
    ...
    <vs-row vs-type="flex" vs-justify="space-between">
      ...
      <vs-col vs-type="flex" vs-justify="flex-end" vs-lg="6" vs-sm="6" vs-xs="12" class="mb-2">
        <inertia-link :href="route('admin.teachers.create')">
          <vs-button color="primary" type="filled">Add Teacher</vs-button>
        </inertia-link>
      </vs-col>
    </vs-row>

    <vs-row class="mt-2" vs-type="flex" v-if="teachers.data.length">
      <vs-col
        vs-type="flex"
        vs-justify="center"
        vs-align="center"
          ...
          <vs-row>
            <vs-col vs-type="flex" vs-justify="flex-end">
              <vs-dropdown>
                ...
                <vs-dropdown-menu>
                  <inertia-link :href="route('admin.teachers.edit',teacher.id)">
                    <vs-dropdown-item>Edit</vs-dropdown-item>
                  </inertia-link>

                  <vs-dropdown-item divider class="text-danger" @click="destroy(teacher)">Delete</vs-dropdown-item>
                </vs-dropdown-menu>
              </vs-dropdown>
            </vs-col>
            <vs-col vs-type="flex" vs-w="4">
              <vs-avatar class="mx-auto mb-6 block" size="75px" :src="teacher.avatar_path" :text="teacher.name" />
            </vs-col>
            <vs-col vs-type="flex" vs-w="8">
              <div class="text-left">
                ...
                <p class="text-grey">
                  ...
                  {{ teacher.contact_no ? teacher.contact_no : 'No Contact' }}
                </p>
                <p class="text-grey">
    ...
    <vs-row>
      <vs-col vs-type="flex" vs-justify="center" class="mt-2 pagi">
        <vs-pagination
          :total="teachers.pagination.total_pages"
...
export default {
  ...
  methods: {
    ...
    acceptDelete() {
      this.$inertia.delete(
        this.route("admin.teachers.destroy", this.teacher.id),
