  ...
  <layout title="Edit">
    <div class="router-header flex flex-wrap items-center mb-6">
      ...
      <div class="ml-auto md:block hidden cursor-pointer">
        <inertia-link :href="route('admin.teachers.index')">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col sm:w-1/2 w-full mb-2">
            ...
            <vs-input
              ...
              :danger="!!$page.errors.teacher_id"
              :danger-text="$page.errors.teacher_id != null ? $page.errors.teacher_id[0] : ''"
            />
...
export default {
  ...
  methods: {
    update() {
      this.$inertia.put(
        this.route("admin.teachers.update", this.teacher.id),
        this.form,
        {
          preserveScroll: true,
          preserveState: true
