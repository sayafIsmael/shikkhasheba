<template>
  <layout title="Edit">
    <div class="router-header flex flex-wrap items-center mb-6">
      ...
      >
        <h2 class="mb-1">Edit Accountant</h2>
      </div>
      ...
      <div class="ml-auto md:block hidden cursor-pointer">
        <inertia-link :href="route('admin.accountants.index')">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col sm:w-1/2 w-full mb-2">
            ...
            <vs-input
              ...
              :danger="!!$page.errors.accountant_id"
              :danger-text="$page.errors.accountant_id != null ? $page.errors.accountant_id[0] : ''"
            />
...
export default {
  ...
  methods: {
    update() {
      this.$inertia.put(
        this.route("admin.accountants.update", this.accountant.id),
        this.form,
        {
          preserveScroll: true,
          preserveState: true
