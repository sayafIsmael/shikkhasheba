  ...
  <layout title="Accountants">
    ...
    <vs-row vs-type="flex" vs-justify="space-between">
      ...
      <vs-col vs-type="flex" vs-justify="flex-end" vs-lg="6" vs-sm="6" vs-xs="12" class="mb-2">
        <inertia-link :href="route('admin.accountants.create')">
          <vs-button color="primary" type="filled">Add Accountant</vs-button>
        </inertia-link>
      </vs-col>
    </vs-row>

    <vs-row class="mt-2" vs-type="flex" v-if="accountants.data.length">
      <vs-col
        vs-type="flex"
        vs-justify="center"
        vs-align="center"
        ...
        vs-sm="12"
        vs-xs="12"
        v-for="(accountant,index) in accountants.data"
        :key="index"
      >
        <vs-card>
          <vs-row>
            <vs-col vs-type="flex" vs-justify="flex-end">
              <vs-dropdown>
                ...
                <vs-dropdown-menu>
                  <inertia-link :href="route('admin.accountants.edit',accountant.id)">
                    <vs-dropdown-item>Edit</vs-dropdown-item>
                  </inertia-link>

                  <vs-dropdown-item divider class="text-danger" @click="destroy(accountant)">Delete</vs-dropdown-item>
                </vs-dropdown-menu>
              </vs-dropdown>
            </vs-col>
            ...
            <vs-col vs-type="flex" vs-w="8">
              <div class="text-left">
                ...
                <p class="text-grey">
                  ...
                  {{ accountant.contact_no ? accountant.contact_no : 'No Contact' }}
                </p>
                <p class="text-grey">
    ...
    <vs-row>
      <vs-col vs-type="flex" vs-justify="center" class="mt-2 pagi">
        <vs-pagination
          :total="accountants.pagination.total_pages"
...
export default {
  ...
  methods: {
    ...
    acceptDelete() {
      this.$inertia.delete(
        this.route("admin.accountants.destroy", this.accountant.id),
