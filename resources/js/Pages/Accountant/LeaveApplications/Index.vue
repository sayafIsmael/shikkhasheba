    ...
    <vs-card>
      ...
      <vs-row vs-type="flex" vs-justify="space-between">
        ...
        <vs-col vs-type="flex" vs-justify="flex-end" vs-lg="6" vs-sm="6" vs-xs="12" class="mb-2">
          <inertia-link :href="route('accountant.leave-applications.create')">
          ...
          >
            ...
            <vs-row vs-type="flex" vs-justify="flex-end">
              <vx-tooltip color="primary" title="Edit" text="Edit leave application info.">
                <inertia-link
                  :href="route('accountant.leave-applications.edit',leaveApplication.id)"
                >
                  <vs-button
                    radius
                    color="primary"
  ...
  methods: {
    filter() {
      ...
      this.$inertia.replace(
        this.route(
          "accountant.leave-applications.index",
    ...
    acceptDelete() {
      ...
      this.$inertia
        .delete(
          this.route(
            "accountant.leave-applications.destroy",
