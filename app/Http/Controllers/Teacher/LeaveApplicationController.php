...
class LeaveApplicationController extends Controller
{
    ...
    {
        return Inertia::render('Teacher/LeaveApplications/Index', [
    ...
    {
        return Inertia::render('Teacher/LeaveApplications/Create', [
    ...
    public function store(Request $request)
    {
        ...
        return Redirect::route('teacher.leave-applications.index')->with('success', 'Leave Application Successfully Submitted.');
    }
    ...
    {
        return Inertia::render('Teacher/LeaveApplications/Edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect::route('teacher.leave-applications.index')->with('success', 'Leave Application Successfully Updated.');
    }
