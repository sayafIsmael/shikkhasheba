...
class LeaveApplicationController extends Controller
{
    ...
    {
        return Inertia::render('Student/LeaveApplications/Index', [
    ...
    {
        return Inertia::render('Student/LeaveApplications/Create', [
    ...
    public function store(Request $request)
    {
        ...
        return Redirect::route('student.leave-applications.index')->with('success', 'Leave Application Successfully Submitted.');
    }
    ...
    {
        return Inertia::render('Student/LeaveApplications/Edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect::route('student.leave-applications.index')->with('success', 'Leave Application Successfully Updated.');
    }
