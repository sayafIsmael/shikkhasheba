            ...
            ? _c(
                ...
                [
                  _c("div", { staticClass: "text-center pb-3" }, [
                    _c("h3", [_vm._v(_vm._s(_vm.school_name))]),
                    _vm._v(" "),
                    _c("h5", [
                      _vm._v(_vm._s(_vm.seatPlan.exam.name) + " exam")
                    ]),
                    _vm._v(" "),
                    _c("h5", [
                      _vm._v("Class : " + _vm._s(_vm.seatPlan.class.name))
                    ]),
                    _vm._v(" "),
                    _c("h5", [
                      _vm._v("Section : " + _vm._s(_vm.seatPlan.section.name))
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
