...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    publishPost: function publishPost() {
      this.$inertia.post(this.route("admin.posts.store"), this.form, {
        preserveScroll: false,
        preserveState: false
      });
    },
    reset: function reset() {
      this.$inertia.visit(this.route("admin.dashboard"));
    },
    ...
    acceptDelete: function acceptDelete() {
      this.$inertia["delete"](this.route("admin.posts.destroy", this.post.id), {
        preserveScroll: true,
        preserveState: true
      });
    },
